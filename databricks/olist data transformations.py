...
storage_account = "olistdheeraj"
application_id = "e8c94366-fbda-42cf-9073-8170b89e8ecb"
directory_id = "26ac1a33-a850-4efc-8a0f-0aca07675609"

spark.conf.set(f"fs.azure.account.auth.type.{storage_account}.dfs.core.windows.net", "OAuth")
spark.conf.set(f"fs.azure.account.oauth.provider.type.{storage_account}.dfs.core.windows.net", "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider")
spark.conf.set(f"fs.azure.account.oauth2.client.id.{storage_account}.dfs.core.windows.net", application_id)
spark.conf.set(f"fs.azure.account.oauth2.client.secret.{storage_account}.dfs.core.windows.net", "VTR8Q~Blb~KTB7yuNdT_VmDA2gR8dmQPe7eclbB~")
spark.conf.set(f"fs.azure.account.oauth2.client.endpoint.{storage_account}.dfs.core.windows.net", f"https://login.microsoftonline.com/{directory_id}/oauth2/token")

# COMMAND ----------

file_path = "abfss://olistdata@olistdheeraj.dfs.core.windows.net/bronze/olist_customers_dataset.csv"
...
base_path = "abfss://olistdata@olistdheeraj.dfs.core.windows.net/bronze/"
...
hostname = "bbm815.h.filess.io"
database = "olist_data_nosql_oppositemy"
port = "61034"
username = "olist_data_nosql_oppositemy"
password = "371a0ad74c2a77432eb23b0ccada5ff76f868ee1"
...
final_df.write.mode("overwrite").parquet("abfss://olistdata@olistdheeraj.dfs.core.windows.net/silver")
